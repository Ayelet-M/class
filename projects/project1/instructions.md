...
team discovered in the Week 1 activities (Mon portfolio, Tue prompting, Wed bias)
and ship a small, hosted app that solves a **real problem one of you actually has.**
...
3. **Project report** — copy [`../project-report-template.md`](../project-report-template.md) to `project-report.md` and fill it in, including the **human-written ethical reflection**.
