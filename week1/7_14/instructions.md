...
- **Compare:** which produced the more original, usable UI? (Often the vibe one!)
...
---
*This assignment is about learning to **steer** the model — measuring the difference, not just getting a result.*
