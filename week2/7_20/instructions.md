...
### Submission
Your repo **is** your submission — there's nothing to upload. Commit and push your `week2/7_20/` folder: your `code_deliverable/` (auto-hosted from your repo via GitHub Pages), `log_deliverable/history.md`, and `vibe-report.md`. We grade from your commit history and your hosted page, so push before the deadline in `deadline.json` — the last commit before it is what counts.
